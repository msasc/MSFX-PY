...
print(order.get_column(0))
print(order.is_asc(0))
print(order.get_column(1))
print(order.is_asc(1))

order_chk = Order()
order_chk.from_string(order.to_string())
print(order_chk)
