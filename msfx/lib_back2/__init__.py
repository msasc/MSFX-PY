...
class ImmutableMeta(type):
    """ Helper to define immutable types. """
    def __setattr__(cls, key, value):
        raise AttributeError(f"Cannot modify the attribute '{key}' in immutable class '{cls.__name__}'.")
    def __delattr__(cls, key):
        raise AttributeError(f"Cannot delete the attribute '{key}' in immutable class '{cls.__name__}'.")
